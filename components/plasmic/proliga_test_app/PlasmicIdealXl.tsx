...
import sty from "./PlasmicIdealXl.module.css"; // plasmic-import: SzuYj3CiWFZL/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(projectcss.all, sty.freeBox___0H94Q)}>
            <div className={classNames(projectcss.all, sty.freeBox___3Tvzf)}>
              <div
                className={classNames(
                  projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox___195X)}>
            <div className={classNames(projectcss.all, sty.freeBox__il6B)}>
              <div className={classNames(projectcss.all, sty.freeBox___9SAf1)}>
                <AntdDropdown
                  className={classNames("__wab_instance", sty.dropdown__nKuab)}
                  dropdownMenuScopeClassName={
                    sty["dropdown__nKuab__dropdownMenu"]
                  }
                  menuItems={() => (
                    <React.Fragment>
                      <AntdMenuItem
                ...
                >
                  <AntdButton
                    className={classNames("__wab_instance", sty.button___5Xmjc)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__jRwl5)}>
              <div className={classNames(projectcss.all, sty.freeBox___5K75I)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__xdh03)}>
              <div className={classNames(projectcss.all, sty.freeBox__wh1Uf)}>
                <SoccerPlaceMens
              ...
              <div className={classNames(projectcss.all, sty.freeBox__uJuE)}>
                <div
                  className={classNames(projectcss.all, sty.freeBox___0IE42)}
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox___6UUxQ)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__yiS4A)}
                  >
                    <AntdDropdown
                      className={classNames(
                        "__wab_instance",
                      ...
                      dropdownMenuScopeClassName={
                        sty["dropdown__xvevk__dropdownMenu"]
                      }
                      menuItems={() => (
                        <React.Fragment>
                          <AntdMenuItem
                ...
                <div
                  className={classNames(projectcss.all, sty.freeBox___1VZwB)}
                >
                  <CmsQueryRepeater
