...
import sty from "./PlasmicImageCardText.module.css"; // plasmic-import: 4PCCEqcdzphM/css
    ...
    >
      ...
      >
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_app/images/_1350731Jpeg.jpg",
            fullWidth: 3840,
            fullHeight: 2160,
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__mMfl)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column___9K786)}
            >
              <div
                className={classNames(
                  projectcss.all,
