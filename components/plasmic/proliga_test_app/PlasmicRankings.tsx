...
import Rankings2 from "../../Rankings2"; // plasmic-import: b4VJUmcvygSD/component
...
import sty from "./PlasmicRankings.module.css"; // plasmic-import: cIO7uK2fZGwJ/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(projectcss.all, sty.freeBox__z6OGb)}>
            <div
              className={classNames(
                projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__wFbJ)}>
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__n5NRf)}
            >
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown__grRVz)}
                dropdownMenuScopeClassName={
                  sty["dropdown__grRVz__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button___9GxAf)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown___7Jxfw)}
                dropdownMenuScopeClassName={
                  sty["dropdown___7Jxfw__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__cFrO)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
              ...
              <AntdDropdown
                className={classNames("__wab_instance", sty.dropdown___6T7G)}
                dropdownMenuScopeClassName={
                  sty["dropdown___6T7G__dropdownMenu"]
                }
                menuItems={() => (
                  <React.Fragment>
                    <AntdMenuItem
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__omOnO)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__bToxl)}>
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__c1Kph)}
              >
                <div className={classNames(projectcss.all, sty.freeBox__mw3CX)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__hzmfT)}>
                <div className={classNames(projectcss.all, sty.freeBox__qzUkG)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__ysc1)}
                  >
                    <PlasmicImg__
