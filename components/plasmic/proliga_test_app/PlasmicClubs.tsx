...
import sty from "./PlasmicClubs.module.css"; // plasmic-import: QoZM5zX7KRbO/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__anHg0)}
      >
        <CmsQueryRepeater
        ...
        >
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__jKwue)}>
                <PlasmicLink__
