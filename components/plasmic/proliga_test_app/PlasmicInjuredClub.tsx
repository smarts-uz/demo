...
import sty from "./PlasmicInjuredClub.module.css"; // plasmic-import: nDtUOyPY4RVH/css
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__o2Csm, {
            [sty.imgvariant1__o2CsmiuGq4]: hasVariant(
              $state,
              "variant1",
              "variant1"
            ),
            [sty.imgvariant2__o2CsmIz6Si]: hasVariant(
              $state,
              "variant2",
              "variant2"
            ),
            [sty.imgvariant3__o2CsmYc9XD]: hasVariant(
              $state,
              "variant3",
              "variant3"
            )
          ...
          src={
            hasVariant($state, "variant3", "variant3")
              ...
              : {
                  src: "/plasmic/proliga_test_app/images/alavespng.png",
                  fullWidth: 120,
                  fullHeight: 120,
                  aspectRatio: undefined
                }
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__tqRis)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_app/images/_1200PxWarningsvgpng.png",
            fullWidth: 1200,
            fullHeight: 1108,
            aspectRatio: undefined
          }}
