...
import sty from "./PlasmicMarket.module.css"; // plasmic-import: tTrNEJYrxVlp/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__mz58C)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__g4TGw
                )}
                mendez={true}
              />

              <MarketMember
                className={classNames("__wab_instance", sty.marketMember__yOeP)}
              />

              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__rZcgr
                )}
                mendez={true}
              />
              ...
              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__s2KvF
                )}
              />
            </div>
            <div className={classNames(projectcss.all, sty.column__zYfsU)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__yReAv
                )}
              />

              <MarketMember
                borjaMayoral={true}
                className={classNames("__wab_instance", sty.marketMember__hWpK)}
              />

              <MarketMember
                className={classNames(
                  "__wab_instance",
                  sty.marketMember__pVyjg
                )}
              />
