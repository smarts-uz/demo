...
import sty from "./PlasmicMatchesCalendar.module.css"; // plasmic-import: FvqZ6jZ3Nmz6/css
...
function PlasmicMatchesCalendar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__gIsJb)}>
        <CmsQueryRepeater
          ...
          <DataCtxReader__>
            {$ctx => (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__noJ5J)}
              >
                <div className={classNames(projectcss.all, sty.freeBox__a1Liw)}>
                  <CmsRowField
                    className={classNames(
                      "__wab_instance",
                      sty.cmsEntryField__vaR4G
                    )}
                ...
                <div className={classNames(projectcss.all, sty.freeBox__icXe)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
                ...
                <div className={classNames(projectcss.all, sty.freeBox__j2Sk2)}>
                  <CmsRowField
                    className={classNames(
                      "__wab_instance",
                      sty.cmsEntryField__aOTuj
                    )}
                    field={(() => {
                      try {
                        return undefined;
