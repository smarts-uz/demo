...
import sty from "./PlasmicBothImageTextCard.module.css"; // plasmic-import: 9KuRJOoenVei/css
...
function PlasmicBothImageTextCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__biMqg)}>
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_app/images/images1Jfif.jpg",
            fullWidth: 300,
            fullHeight: 168,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__kxcz1)}>
        <div className={classNames(projectcss.all, sty.freeBox__mfXu)}>
          <Stack__
            as={"div"}
          ...
          >
            <div className={classNames(projectcss.all, sty.column__gZbqT)}>
              <div
                className={classNames(
                  projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.column__rzXin)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
