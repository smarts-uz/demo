...
import sty from "./PlasmicInjuredTeamMember.module.css"; // plasmic-import: WNvy9DWprfhO/css
...
export const PlasmicInjuredTeamMember__VariantProps =
  new Array<VariantPropType>("unnamedVariant");
  ...
  return (
    ...
    >
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__oWs3H)}
          displayHeight={"auto"}
        ...
        <PlasmicLink__
          ...
          className={classNames(
            ...
            sty.link,
            {
              [sty.linkunnamedVariant]: hasVariant(
                $state,
                "unnamedVariant",
                "unnamedVariant"
              )
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__aKVv5)}
          displayHeight={"20px"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/proliga_test_app/images/crossMedicalCircle512Webp.webp",
            fullWidth: 512,
            fullHeight: 512,
            aspectRatio: undefined
          }}
