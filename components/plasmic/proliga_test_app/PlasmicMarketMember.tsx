...
import sty from "./PlasmicMarketMember.module.css"; // plasmic-import: FbNpDs8gKIO3/css
...
function PlasmicMarketMember__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ncWOu)}>
        <div className={classNames(projectcss.all, sty.freeBox__w2N8)}>
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img___7EAX, {
              [sty.imgborjaMayoral___7EAX2EJn]: hasVariant(
                $state,
                "borjaMayoral",
                "borjaMayoral"
              ),
              [sty.imgmendez___7EAXE2K1L]: hasVariant(
                $state,
                "mendez",
                "mendez"
              ),
              [sty.imgpedri___7EAX5Wkxg]: hasVariant($state, "pedri", "pedri")
            })}
            displayHeight={"112px"}
          ...
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__nhrFp, {
              [sty.imgborjaMayoral__nhrFp2EJn]: hasVariant(
                $state,
                "borjaMayoral",
                "borjaMayoral"
              ),
              [sty.imgmendez__nhrFpe2K1L]: hasVariant(
                $state,
                "mendez",
                "mendez"
              ),
              [sty.imgpedri__nhrFp5Wkxg]: hasVariant($state, "pedri", "pedri")
            })}
            displayHeight={"28px"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            ...
            src={
              hasVariant($state, "mendez", "mendez")
                ? {
                    src: "/plasmic/proliga_test_app/images/osasunapng.png",
                    fullWidth: 120,
                    fullHeight: 120,
                    aspectRatio: undefined
                  }
                : hasVariant($state, "pedri", "pedri")
                ? {
                    src: "/plasmic/proliga_test_app/images/fcBarcelonapng.png",
                    fullWidth: 96,
                    fullHeight: 100,
                    aspectRatio: undefined
                  }
                : hasVariant($state, "borjaMayoral", "borjaMayoral")
                ? {
                    src: "/plasmic/proliga_test_app/images/cadizpng.png",
                    fullWidth: 1024,
                    fullHeight: 1024,
                    aspectRatio: undefined
                  }
                : {
                    src: "/plasmic/proliga_test_app/images/realMadridpng.png",
                    fullWidth: 80,
                    fullHeight: 104,
                    aspectRatio: undefined
                  }
        ...
        <div className={classNames(projectcss.all, sty.freeBox___9WMzz)}>
          <div className={classNames(projectcss.all, sty.freeBox__tpvBk)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
                ...
                sty.link__bjPsY,
                {
                  [sty.linkmendez__bjPsYe2K1L]: hasVariant(
                    $state,
                    "mendez",
                    "mendez"
                  )
            ...
            <div
              className={classNames(
                ...
                sty.text__oPPuM,
                {
                  [sty.textborjaMayoral__oPPuM2EJn]: hasVariant(
                    $state,
                    "borjaMayoral",
                    "borjaMayoral"
                  ),
                  [sty.textmendez__oPPuMe2K1L]: hasVariant(
                    $state,
                    "mendez",
                    "mendez"
                  ),
                  [sty.textpedri__oPPuM5Wkxg]: hasVariant(
                    $state,
                    "pedri",
                    "pedri"
                  )
          ...
          <div className={classNames(projectcss.all, sty.freeBox__mUOp)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__bh08C)}>
          <div className={classNames(projectcss.all, sty.freeBox__tdGM)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
                ...
                sty.link___205Hs,
                {
                  [sty.linkborjaMayoral___205Hs2EJn]: hasVariant(
                    $state,
                    "borjaMayoral",
                    "borjaMayoral"
                  ),
                  [sty.linkmendez___205HsE2K1L]: hasVariant(
                    $state,
                    "mendez",
                    "mendez"
                  ),
                  [sty.linkpedri___205Hs5Wkxg]: hasVariant(
                    $state,
                    "pedri",
                    "pedri"
                  )
